...
const usersModel = new UsersModel(dataManager);

(async () => {
    try {
        await dataManager.init();
        console.log('Data manager initialization succeeded.');
    } catch (err) {
        console.log('Data manager initialization failed: ' + err.message);
    }
})();
